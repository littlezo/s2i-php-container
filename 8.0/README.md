...
the CentOS images are available on [Docker Hub](https://hub.docker.com/r/little/php-80-centos7),
...
Usage
---------------------
For this, we will assume that you are using the `rhscl/php-80-rhel7 image`, available via `php:8.0` imagestream tag in Openshift.
Building a simple [php-test-app](https://github.com/sclorg/s2i-php-container/tree/master/8.0/test/test-app) application
in Openshift can be achieved with the following step:

    ```
    oc new-app php:8.0~https://github.com/sclorg/s2i-php-container.git --context-dir=8.0/test/test-app/
    ```

The same application can also be built using the standalone [S2I](https://github.com/openshift/source-to-image) application on systems that have it available:

    ```
    $ s2i build https://github.com/sclorg/s2i-php-container.git --context-dir=8.0/test/test-app/ rhscl/php-80-rhel7 php-sample-app
    ```
